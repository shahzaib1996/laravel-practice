...
Route::get('add-credentials', 'MyDBController@credentials');
Route::get('show-databases', 'DatabaseController@listDatabase');
Route::post('show-tables', 'DatabaseController@listTables');
// Route::get('show-table-data', 'DatabaseController@showTableData');
Route::get('show-table-data', 'DatabaseController@showAjaxData');
Route::get('show-table-data/fetch_data', 'DatabaseController@fetch_data');
